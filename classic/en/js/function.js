...
function loadData()
{
  ...
  $.get("https://raw.githubusercontent.com/kiang/pharmacies/master/json/points.json", function(source)
  {
    ...
    {
      console.log(source);
      popWindow('Mask Guide is not available are this point. Please try again later.','Got it','n');
      return;
    }
